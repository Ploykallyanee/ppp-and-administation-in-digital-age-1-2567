...
export default function EditProductForm({
  ...
  const [newMobilele, setNewMobile] = useState(mobile);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`http://localhost:3000/api/products/${id}`, {
        ...
        body: JSON.stringify({ newName, newProject, newImplementation, newEmail , newMobilele , newBudget , newYear , newEvaluation , newWeak , newStrength , newDevelopment , newSuggestion }),
      });
